...
struct CinematicMechanismTheatre: View {
    ...
    @State private var stageGlow = false
    ...
    private var cinematicStageBackground: some View {
        ZStack {
            ...
            Circle()
                .fill(ChemVaultTheme.accent.opacity(stageGlow ? 0.16 : 0.08))
                .frame(width: stageGlow ? 300 : 250, height: stageGlow ? 300 : 250)
                .blur(radius: 56)
                .offset(x: -110, y: -70)
            
            Circle()
                .fill(Color.blue.opacity(stageGlow ? 0.12 : 0.06))
                .frame(width: stageGlow ? 280 : 230, height: stageGlow ? 280 : 230)
                .blur(radius: 60)
                .offset(x: 130, y: 90)
